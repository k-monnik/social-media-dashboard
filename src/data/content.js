export const upperData = [
    {
        ...
        "arrow": <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4">
        ...
        "border": "py-4 px-14 border-solid border-t-4 border-social-blue rounded bg-light-200 space-y-4 text-light-300 md:w-64 md:h-56"
    },
    {
        "name": "@nathanf",
        "quantity": "1044",
        ...
        "color": "flex gap-x-1 justify-center items-center text-lime font-bold text-xs",
        "border": "py-4 px-14 border-solid border-t-4 border-social-bluebird rounded bg-light-200 space-y-4 text-light-300 md:w-64 md:h-56"
    },
    {
        "name": "@realnathanf",
        "quantity": "11k",
        ...
        "color": "flex gap-x-1 justify-center items-center text-lime font-bold text-xs",
        "border": "py-4 px-14 border-solid border-t-4 border-social-yellow rounded bg-light-200 space-y-4 text-light-300 md:w-64 md:h-56"
    },
    {
        "name": "Nathan F.",
        "quantity": "8239",
        ...
        "border": "py-4 px-14 border-solid border-t-4 border-social-red rounded bg-light-200 space-y-4 text-light-300 md:w-64 md:h-56"
    },
];
...
export const lowerData = [
    {
        ...
        "quantity": "87",
        "status": "3%",
        // "icon": require("../../src/images/icon-facebook.svg")
        "icon": <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
            <path fill="#178FF5"
                d="M18.896 0H1.104C.494 0 0 .494 0 1.104v17.793C0 19.506.494 20 1.104 20h9.58v-7.745H8.076V9.237h2.606V7.01c0-2.583 1.578-3.99 3.883-3.99 1.104 0 2.052.082 2.329.119v2.7h-1.598c-1.254 0-1.496.597-1.496 1.47v1.928h2.989l-.39 3.018h-2.6V20h5.098c.608 0 1.102-.494 1.102-1.104V1.104A1.102 1.102 0 0 0 18.896 0z" />
