...
const UpperGrid = () => {
    return (
        <div className="grid gap-10 grid-cols-1 md:grid-cols-4 md:w-[1110px] md:h-[216px] md:flex md:justify-center md:space-x-2">
            ...
            <div
                className="p-4 mx-12 border-solid rounded bg-light-200 space-y-4 text-light-300 border-t-4 border-social-bluebird md:w-[326px] md:h-[216px] md:justify-center"
            >
                <div className="flex gap-x-3 justify-center font-bold text-xs">
            ...
            <div
                className="p-4 mx-12 border-solid rounded bg-light-200 space-y-4 text-light-300 border-t-4 border-[bg-gradient-to-r from-cyan-500 to-blue-500] md:w-[326px] md:h-[216px] md:justify-center"
            >
                <div className="flex gap-x-3 justify-center font-bold text-xs">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
                        <defs>
            ...
            <div
                className="p-4 mx-12 border-solid rounded bg-light-200 space-y-4 text-light-300 border-t-4 border-social-red md:w-[326px] md:h-[216px] md:justify-center"
            >
                <div className="flex gap-x-3 justify-center font-bold text-xs">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
                        <path fill="#C4032B"
                ...
                <div className="flex gap-x-1 justify-center items-center text-red font-bold text-xs">
                    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4">
