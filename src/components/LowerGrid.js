...
const LowerGrid = () => {
    return (
        <div>
            ...
            <div className="m-4 text-light-300 font-bold text-lg">
                Overview - Today
            </div>

            {/* BOTTOM GRID  */}

            <div className="p-4 grid gap-10 grid-cols-1 md:grid-cols-4 md:grid-rows-2">
                ...
                <div className="py-6 px-8 mx-8  border-solid border-1 rounded-md bg-light-200 md:justify-items-center text-light-300">
                    ...
                    <div className="pt-6 flex items-end justify-between">
                        ...
                        <div className="flex items-center gap-x-1 text-red font-bold text-xs">
                            <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4">
