...
const LowerCard = ({ data }) => {
    return <>
        <div className="mx-auto py-6 px-8 border-solid border-1 rounded-md bg-light-200 dark:bg-dark-200 md:justify-items-center text-light-300 h-32 w-80 md:w-64">
